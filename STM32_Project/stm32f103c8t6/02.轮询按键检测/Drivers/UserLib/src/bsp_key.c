...
static const bsp_key_hw_t bsp_key_hw[KEY_MAX] = {
	[KEY1] = {GPIOA, GPIO_Pin_0, RCC_APB2Periph_GPIOA, GPIO_Mode_IPU, Bit_RESET},
	[KEY2] = {GPIOA, GPIO_Pin_1, RCC_APB2Periph_GPIOA, GPIO_Mode_IPU, Bit_RESET}
};
...
{
	if(key >= KEY_MAX)	return BSP_KEY_RELEASED;
