...
* @{
*/
#define PRODUCT_KEY "23a62aeaeafb43f89d54504868413f8a"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "20031c5f33f3446abdf831b7f6d67e85"

/**@} */
//#define OTA_ENABLE              //OTA ENABLE
// #define DATA_CONFIG_ENABLE                        ///Enabling environment parameter configuration


/**@to configure environment parameters, enable macro definition
* @{
*/
#ifdef DATA_CONFIG_ENABLE

#define GIZ_SOFTAP_MODE       "1"                 ///< Softap mode
#define GIZ_AIRLINK_MODE      "2"                 ///< Airlink mode

#define AP_NAME               "XPG-GAgent-"       ///< Hotspot name
#define AP_PWD                "123456789"         ///< Hotspot Password
#define CFG_MODE              GIZ_SOFTAP_MODE     ///< Initialize function mode
...
#define MAX_PACKAGE_LEN    (sizeof(devStatus_t)+sizeof(attrFlags_t)+270)                ///< Data buffer maximum length
...
* @{
*/
#define chuanghu_BYTEOFFSET                    0
#define chuanghu_BITOFFSET                     0
#define chuanghu_LEN                           1
#define baojing_BYTEOFFSET                    0
#define baojing_BITOFFSET                     1
#define baojing_LEN                           1

#define co_RATIO                         1
#define co_ADDITION                      0
#define co_MIN                           0
#define co_MAX                           100
#define guang_RATIO                         1
#define guang_ADDITION                      0
#define guang_MIN                           0
#define guang_MAX                           100
#define temp_RATIO                         1
...
typedef struct {
    uint8_t flagchuanghu:1;
    uint8_t flagbaojing:1;
} attrFlags_t;
