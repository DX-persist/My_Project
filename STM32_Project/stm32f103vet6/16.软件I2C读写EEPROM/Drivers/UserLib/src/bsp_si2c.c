...
/**
 * @brief  向寄存器写入数据 (Start -> Addr(W) -> Reg -> Data -> Stop)
 */
...
/**
 * @brief  读取寄存器数据 (Start -> Addr(W) -> Reg -> Start -> Addr(R) -> Data -> Stop)
 */
