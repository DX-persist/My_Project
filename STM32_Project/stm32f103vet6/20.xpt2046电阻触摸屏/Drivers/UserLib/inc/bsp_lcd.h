...
extern void BSP_LCD_SetScanDir(uint8_t option);
...
extern void BSP_LCD_DrawChar(uint16_t x, uint16_t y, const uint8_t *font, uint8_t width, uint8_t height, uint16_t fg_color, uint16_t bg_color);
