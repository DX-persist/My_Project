...
extern volatile uint8_t recv_data;
...
extern uint8_t BSP_USART_ReceiveByte(bsp_usart_t id);
extern uint8_t BSP_USART_ReceiveString(bsp_usart_t id, uint8_t *buff, uint8_t len);
extern void BSP_USART_IRQHandler(bsp_usart_t id);
